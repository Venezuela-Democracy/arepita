...
WELCOME_MINI_APP: '🎮 *¡Bienvenido a VzlaDAO!*\n\nUsa el botón de abajo para abrir nuestra app y comenzar tu aventura en el metaverso venezolano.',
...
WELCOME_MINI_APP: '🎮 *Welcome to VzlaDAO!*\n\nUse the button below to open our app and start your adventure in the Venezuelan metaverse.',
